...
export default function ExtraDetailsV2() {
    ...
    return (
        <Formik initialValues={inital} validationSchema={} onSubmit={handleSubmit}>
            <Form className="col border-2= lg:w-96 p-3 text-left center gap-2">
